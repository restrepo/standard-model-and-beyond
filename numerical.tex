...
% We start with QCD Lagrangian. In the LanHEP notation, the file \lstinline{qcd.mdl} is
% \begin{lstlisting}
% model QED/1.
...
% \begin{align}
%   \mathcal{L}=-\frac{1}{4}F^{\mu\nu}F_{\mu\nu}+\overline{e}\gamma^\mu(i\partial_\mu+e A_\mu)e-m\overline{e}e+\mathcal{L}_{\text{GF}}\,,
% \end{align}
% where the gauge fixing term in the Feynman Gauge is
% \begin{align}
%   \mathcal{L}_{\text{GF}}=-\frac{1}{2}  \left(\partial_\mu A^\mu  \right)^2\,.
% \end{align}
