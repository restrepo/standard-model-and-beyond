...
and
\begin{align}
  \widehat{\mathcal{N}}_n|m_n\rangle=m|m_n\rangle
\end{align}
...
\end{align}
\begin{align}
  \widehat{\mathcal{N}}_n\widehat{a}_n|m_n\rangle=&(m-1)\widehat{a}_n|m_n\rangle
\end{align}
Since the state
\begin{align}
   \widehat{\mathcal{N}}_n|m_n-1\rangle=&(m-1)|m_n-1\rangle
\end{align}
...
\end{align}
\begin{align}
  \widehat{a}_n|m_n\rangle=\sqrt{m}|m_n-1\rangle
\end{align}
...
we have that
\begin{align}
  \langle m_n|\colon\!\widehat{H}\colon|m\rangle=m_n \omega_n=m \hbar\omega_n\,.
\end{align}
