...
\begin{itemize}
\item Initial particle: ${u}(p)$ \includegraphics{frip}
\item Initial antiparticle: $\bar{v}(p)$ \includegraphics{fria}
\item Final particle: $\bar{u}(p)$ \includegraphics{frfp}
\item Final antiparticle: ${v}(p)$ \includegraphics{frfa}
