...
\mode<presentation>{\input{cft}}
\mode<presentation>{\input{numerical}}
\mode<presentation>{\input{sndquantization}}
\mode<presentation>{\input{smatrix}}
\mode<presentation>{\input{greenbeamer}}
\mode<presentation>{\input{feynmanweyl}}
\mode<presentation>{\input{seesaw}}
