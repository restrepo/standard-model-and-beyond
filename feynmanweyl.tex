...
Using \eqref{eq:xxd}
\begin{align}
  \left| \mathcal{M}_1 \right| = &y^4 \Delta_F^2(p_1-p_2')\,p_2\cdot \sigma_{\beta\dot{\beta}} x_{\dot{\alpha}}^{\dagger}  \sum_{\text{spins}}y^{\alpha}(\mathbf{p}_1')y^{\beta}(\mathbf{p}_2') x_{\alpha}(\mathbf{p}_1)(\mathbf{p}_1)y^{\dagger\dot{\beta}} (\mathbf{p}_2') y^{\dagger\dot{\alpha}}(\mathbf{p}_1') \nonumber\\
...
\end{align}
\begin{align}
  = &y^4 \Delta_F^2(p_1-p_2')\, p_2\cdot \sigma_{\beta\dot{\beta}} p_1\cdot \sigma_{\alpha\dot{\alpha}} y^{\dagger\dot{\beta}}  \sum_{\text{spins}}y^{\alpha}(\mathbf{p}_1')y^{\beta}(\mathbf{p}_2')  (\mathbf{p}_2') y^{\dagger\dot{\alpha}}(\mathbf{p}_1') \nonumber\\
\end{align}
Since
\begin{align}
