...
=& 
 ...
 \frac{(-iy)^2}{2!}\int\int d^4x_1 d^4x_2\,:(\overline{\psi}
...
\begin{align}
  S_{fi}=\frac{\left( -ih \right)^{2}}{2!}\int\int \operatorname{d}^4x_1 \operatorname{d}^4x_2
\bcontraction{\,}{\phi}{(x_1)}{\phi}\,\phi(x_1)\phi(x_2)
\left[ \left\langle e_L \left(\mathbf{p}'_1\right), e_L\left(\mathbf{p}'_2\right) \right|\xi_{-\dot{\alpha}}^{\dagger} \xi_{-}^{\dagger\dot{\alpha}}\eta_+^{\alpha}\eta_{+\alpha}
 \left| e_R\left(\mathbf{p}_1\right), e_R \left(\mathbf{p}_1\right)\right\rangle \right. \nonumber\\
\end{align}
...
\begin{align}
  |e_L(\mathbf{p}_1)e_L(\mathbf{p}_2)\rangle=&\frac{1}{\sqrt{V}}a_s^\dagger(\mathbf{p}_2)a_s^\dagger(\mathbf{p}_1)|0\rangle
\end{align}
Therefore
\begin{align}
  \xi^\alpha_+(x_1)\xi^\beta_+(x_2)|e^-(\mathbf{p}_1)e^-(\mathbf{p}_2)\rangle=&
\int\frac{d^3k}{\sqrt{2E_k V}}\int\frac{d^3k}{\sqrt{2E_{k'}V}}
x^\alpha(s,\mathbf{k})x^\beta(s',\mathbf{k}')e^{-i k\cdot x_1}e^{-i k'\cdot x_2}\nonumber\\
&\times a_s(\mathbf{k})a_{s'}(\mathbf{k}')a_s^\dagger(\mathbf{p}_2)a_s^\dagger(\mathbf{p}_1)|0\rangle
\end{align}
