...
\begin{align}
  ...
  =&2x^{\alpha}(\mathbf{p}_1)x_{\alpha}(\mathbf{p}_2)x^{\dagger}_{\dot{\alpha}}(\mathbf{p}_2') x^{\dagger\dot{\alpha}}(\mathbf{p}_1')  \nonumber\\
  =&2x(\mathbf{p}_1)x(\mathbf{p}_2)x^{\dagger}(\mathbf{p}_2')x^{\dagger}(\mathbf{p}_1')
\end{align}
\begin{align}
